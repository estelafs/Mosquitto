...
public class Cliente implements MqttCallbackExtended {

    private final String serverURI;
    private MqttClient client;
    private final MqttConnectOptions mqttOptions;

    public Cliente(String serverURI, String usuario, String senha) {
    ...
    public void iniciar() {
        try {
            System.out.println("Conectando no broker momsquitto em " + serverURI);
            ...
            System.out.println("Erro ao se conectar: " + serverURI + " - " + ex);
        }
    }
    ...
    public void connectComplete(boolean reconnect, String serverURI) {
        System.out.println("Cliente " + (reconnect ? "reconectado" : "conectado") + " com o broker " + serverURI);
    }
